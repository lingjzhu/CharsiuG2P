...
- Each word must be proceeded by a language code prefix, which is based on ISO-639 with some slight modification to distinguish local dialects. For example, the prefix code for American English is '\<eng-us\>: ' (**The space following the colon cannot be omitted！**). The full list of language codes can be found in this [document](https://docs.google.com/spreadsheets/d/1y7kisk-UZT9LxpQB0xMIF4CkxJt0iYJlWAnyj6azSBE/edit#gid=557940309). 
...
preds = model.generate(**out,num_beams=1) # We do not find beam search helps. Greedy decoding is enough. 
